...
- **[Created a Table named animals]**
- **[Inserted data into the table with appropriate syntax]**
...
```sh
  cd my-folder
  https://github.com/unorjikingsley/Vet-Clinic-Database.git
```
...
- LinkedIn: [LinkedIn](https://linkedin.com/in/unorjikingsley)
...
If you like this project give it a star ⭐ and suggest ways to improve on it.
